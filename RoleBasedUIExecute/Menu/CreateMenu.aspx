<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CreateMenu.aspx.cs" Inherits="UIExecute.Menu.CreateMenu" %>
...
<center><tr>
   <td><h1> Create New Menu Form</h1></td>
</tr><center>
...
<tr>
    ...
    <td>
      <%--  <input type='text' name='name'>--%>
        ...
        <asp:DropDownList ID="ddlrole" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlrole_SelectedIndexChanged">
        </asp:DropDownList>
...
<tr>
    ...
    <td>
        &nbsp;</td>
    <td>
        <asp:TextBox ID="txtmenuurl" Enabled="false" runat="server" Width="300px"></asp:TextBox>
...
<tr>
    ...
    <td>
        &nbsp;</td>
    <td>
        <asp:Button ID="btncreatemenu" runat="server" Text="Create Menu" />
...
<tr>
    ...
    <td align='left' colspan="3">
            <asp:GridView ID="grdmenu" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
